...
<table width="1250" border="0" align="center">
        <tr>
          ...
          <td width="1250"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Smart Healthcare</strong></td>
...
echo"</br></br>";
echo"<tr>";echo"<td>Folio No";echo"</td>";echo"<td><strong>".$row['foliono'];echo"</td>";echo"<td>Customer Name";echo"</td>";echo"<td><strong>".$row['name'];echo"</td>";echo"</tr>";

echo"<tr>";echo"<td>RPrescribed By";echo"</td>";echo"<td><strong>".$row['ron'];echo"</td>";echo"<td>Mobile No";echo"</td>";echo"<td><strong>".$row['mno'];echo"</td>";echo"</tr>";
...
echo"<tr>";echo"<td>Personal Address";echo"</td>";echo"<td><strong>".$row['pa'];echo"</td>";echo"<td> Address";echo"</td>";echo"<td><strong>".$row['pea'];echo"</td>";echo"</tr>";

echo"<tr>";echo"<td>";echo"</td>";echo"<td>";echo"</td>";echo"<td>";echo"</td>";echo"<td>";echo"</td>";echo"</tr>";

echo"<tr>";echo"<td><strong>S.No</strong>";echo"</td>";echo"<td><strong>Medicine Particulars</strong>";echo"</td>";echo"<td><strong>Quantity</strong>";echo"</td>";echo"<td><strong>Amount</strong>";echo"</td>";echo"</tr>";
