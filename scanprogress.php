...
<title>Scanning for Phishing</title>
...
if (min == 0 && sec == 0) 
{
window.alert("Secure http://,Secure https://,Secure Hyperlinks,Secure Tags,Inactive Blankstags,Secure ConnectionWifi Inactive,Safe Site,Secure IP ");
...
<body bgcolor="pink" onLoad="timeIt();">
<script language=JavaScript>
<!--
...
<form name="timerform">
  ...
  <div align="center">
    ...
    <tr>
      <td><p>
        <input type="hidden" name="clock" size="7" value="00:15" >
      </p>
